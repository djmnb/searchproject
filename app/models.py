...
class User(models.Model):
    ...
    password = models.CharField(max_length=20,verbose_name="密码",editable=False)
    ...
    tokens = models.IntegerField(verbose_name="剩余token数量",default=10)
    upload_count = models.IntegerField(verbose_name="上传题目数量",default=0,editable=False)
    is_admin = models.BooleanField(verbose_name="用户身份",default=False)
